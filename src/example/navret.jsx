  ...
  return (
    <Container>
        <header ref={headerRef} className=' header'>
            <div className='navbar container d-flex align-items-center justify-content-between'  data-aos='zoom-in' data-aos-delay='100'>
                <div className="logo">
                ...
                <div className="nav-button d-flex align-items-center gap-4" data-aos='zoom-in' data-aos-delay='100'>
